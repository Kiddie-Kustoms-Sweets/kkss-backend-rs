...
#[openapi(
    paths(
        ...
        handlers::admin::get_overview,
        handlers::admin::get_coupon_stats,
        handlers::admin::list_users,
        handlers::admin::get_user_detail,
        handlers::admin::get_user_referrals,
        handlers::admin::adjust_balance,
        handlers::admin::adjust_stamps,
        handlers::admin::grant_coupon,
        handlers::admin::list_coupons,
        handlers::admin::revoke_coupon,
    ),
    components(
        schemas(
            UserResponse,
